...
birthdate_str = input("Enter your date of birth: ") # input date of birth MM/DD/YYYY format only

birthdate = datetime.datetime.strptime(birthdate_str,"%m/%d/%Y").date() # converts birthdate_str to a date

today = datetime.date.today() # gets today's date
age = today.year - birthdate.year - ((today.month, today.day) < (birthdate.month, birthdate.day)) # gets your age
name = f"{fName} {lName}" # your name

if(birthdate.month < today.month or birthdate.month == today.month and birthdate.day < today.day): # if your birthday has passed
  print(f"Hello {name}. You are {age} years old.")
elif(birthdate.month > today.month): # if your birthday is upcoming
  print(f"Hello {name}, You will be {age} years old.")
  ...
  if(birthdate.day == today.day): # if your birthday is today
    ...
    print(f"It's your birthday soon {name}, You will be {age} years old.")
